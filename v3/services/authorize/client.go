...
type AuthorizeClient interface {
	...
	AddResourceRelation(resource, parent *common.Origin) error
	AddResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error
	...
	RemoveResourceRelation(resource, parent *common.Origin) error
	RemoveResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error
