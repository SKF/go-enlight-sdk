...
func (mock *Client) AddResourceRelation(resource, parent *common.Origin) error {
	args := mock.Called(resource, parent)
	return args.Error(0)
}

func (mock *Client) AddResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error {
	args := mock.Called(ctx, resource, parent)
	return args.Error(0)
}

func (mock *Client) RemoveResourceRelation(resource, parent *common.Origin) error {
	args := mock.Called(resource, parent)
	return args.Error(0)
}

func (mock *Client) RemoveResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error {
	args := mock.Called(ctx, resource, parent)
	return args.Error(0)
}
