...
func (c *client) IsAuthorizedBulkWithResources(ctx context.Context, userID, action string, resourcesInput []*common.Origin) ([]*common.Origin, []bool, error) {
...
func (c *client) AddResourceRelation(resource, parent *common.Origin) error {
	ctx, cancel := context.WithTimeout(context.Background(), c.requestTimeout)
	defer cancel()
	return c.AddResourceRelationWithContext(ctx, resource, parent)
}

func (c *client) AddResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error {
...
func (c *client) RemoveResourceRelation(resource, parent *common.Origin) error {
	ctx, cancel := context.WithTimeout(context.Background(), c.requestTimeout)
	defer cancel()
	return c.RemoveResourceRelationWithContext(ctx, resource, parent)
}

func (c *client) RemoveResourceRelationWithContext(ctx context.Context, resource, parent *common.Origin) error {
