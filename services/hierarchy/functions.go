...
// create it.
func (c *Client) SaveNode(request proto_hierarchy.SaveNodeInput) (string, error) {
...
// SaveNode will add the node if it this not exist and otherwise
// create it.
func (c *Client) SaveNodeWithContext(ctx context.Context, request proto_hierarchy.SaveNodeInput) (string, error) {
	resp, err := c.api.SaveNode(ctx, &request)
	return resp.GetValue(), err
}

// GetNode takes an id of a node and returns the node.
func (c *Client) GetNode(uuid string) (node proto_hierarchy.Node, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
func (c *Client) GetNodeWithContext(ctx context.Context, uuid string) (node proto_hierarchy.Node, err error) {
	resp, err := c.api.GetNode(ctx, &proto_common.PrimitiveString{Value: uuid})
	if resp != nil {
		node = *resp
	}
	return
...
func (c *Client) GetNodeIDByOrigin(origin proto_common.Origin) (string, error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
func (c *Client) GetNodeIDByOriginWithContext(ctx context.Context, origin proto_common.Origin) (string, error) {
...
// an argument.
func (c *Client) GetNodes(parentID string) (nodes []proto_hierarchy.Node, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
// an argument.
func (c *Client) GetNodesWithContext(ctx context.Context, parentID string) (nodes []proto_hierarchy.Node, err error) {
	resp, err := c.api.GetNodes(ctx, &proto_common.PrimitiveString{Value: parentID})
	if resp != nil {
...
// an argument.
func (c *Client) GetChildNodes(parentID string) (nodes []proto_hierarchy.Node, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
// an argument.
func (c *Client) GetChildNodesWithContext(ctx context.Context, parentID string) (nodes []proto_hierarchy.Node, err error) {
	resp, err := c.api.GetChildNodes(ctx, &proto_common.PrimitiveString{Value: parentID})
	if resp != nil {
		for _, node := range resp.Nodes {
			if node != nil {
				nodes = append(nodes, *node)
...
// an argument.
func (c *Client) DeleteNode(request proto_hierarchy.DeleteNodeInput) error {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
// an argument.
func (c *Client) DeleteNodeWithContext(ctx context.Context, request proto_hierarchy.DeleteNodeInput) error {
...
// an argument.
func (c *Client) GetParentNode(nodeID string) (node proto_hierarchy.Node, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
// an argument.
func (c *Client) GetParentNodeWithContext(ctx context.Context, nodeID string) (node proto_hierarchy.Node, err error) {
	resp, err := c.api.GetParentNode(ctx, &proto_common.PrimitiveString{Value: nodeID})
	if resp != nil {
		node = *resp
	}
	return
...
func (c *Client) GetAncestors(nodeID string) (nodes []proto_hierarchy.AncestorNode, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*10)
	defer cancel()
...
// it takes as an argument.
func (c *Client) GetAncestorsWithContext(ctx context.Context, nodeID string) (nodes []proto_hierarchy.AncestorNode, err error) {
	resp, err := c.api.GetAncestors(ctx, &proto_hierarchy.GetAncestorsInput{NodeId: nodeID})
	if resp != nil {
		for _, node := range resp.Nodes {
			if node != nil {
				nodes = append(nodes, *node)
...
func (c *Client) GetEventsWithContext(ctx context.Context, since int, limit *int32) (events []eventsource.Record, err error) {
	input := proto_hierarchy.GetEventsInput{Since: int64(since)}
	if limit != nil {
