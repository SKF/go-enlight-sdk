...
func (mock *client) SendNotification(notificationType proto.NotificationType, resource common.Origin, header, body, createdBy string) (string, error) {
	args := mock.Called(notificationType, resource, header, body, createdBy)
	return args.String(0), args.Error(1)
}

func (mock *client) SendNotificationWithContext(ctx context.Context, notificationType proto.NotificationType, resource common.Origin, header, body, createdBy string) (string, error) {
