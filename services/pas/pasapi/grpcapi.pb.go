...
func (AlarmStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{0}
}
...
func (IntervalType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{1}
}
...
type SetPointThresholdInput struct {
	...
	Intervals            []*AlarmStatusInterval `protobuf:"bytes,2,rep,name=intervals,proto3" json:"intervals,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*SetPointThresholdOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{2}
}
...
func (*GetPointThresholdInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{3}
}
...
type GetPointThresholdOutput struct {
	Intervals            []*AlarmStatusInterval `protobuf:"bytes,1,rep,name=intervals,proto3" json:"intervals,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*GetPointThresholdOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{4}
}
...
func (m *GetPointThresholdOutput) GetIntervals() []*AlarmStatusInterval {
	if m != nil {
		return m.Intervals
	}
	return nil
...
func (*SetPointStatusInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{5}
}
...
func (*SetPointStatusOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{6}
}
...
func (*GetPointStatusInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{7}
}
...
func (*GetPointStatusOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{8}
}
...
func (*GetPointStatusStreamInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{9}
}
...
func (*GetPointStatusStreamOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{10}
}
...
func (*Void) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{11}
}
...
func (*AlarmStatusInterval) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpcapi_4938e34e9aebbcbf, []int{12}
}
...
func init() {
	proto.RegisterFile("services/pas/pasapi/grpcapi.proto", fileDescriptor_grpcapi_4938e34e9aebbcbf)
}

var fileDescriptor_grpcapi_4938e34e9aebbcbf = []byte{
	// 638 bytes of a gzipped FileDescriptorProto
	,
}
